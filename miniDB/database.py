...
class Database:
    ...
    def select(self, columns, table_name, condition,group_by,having_condition, order_by=None, top_k=True,\
        ...
        if self._has_index(table_name) and condition_column==self.tables[table_name].column_names[self.tables[table_name].pk_idx]:
            ...
            table = self.tables[table_name]._select_where(columns, condition,group_by ,having_condition,order_by, desc, top_k)
        # self.unlock_table(table_name)
